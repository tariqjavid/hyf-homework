...
const func1=function(){console.log("it is fuction1")}// function expression
const func2=()=>{console.log("it is fuction2")};//arrow fuction
function func3(){console.log("it is fuction3")} // Normal fuction
...
let obj={id:1,key:function(){console.log("i am fuction inside the object")}};
